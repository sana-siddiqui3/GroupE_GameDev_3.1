...
public class NarrativeManager : MonoBehaviour
{
    ...
    private Dictionary<string, string> levelNarratives = new Dictionary<string, string>
    {
        ...
        { "Room4", "The final chamber awaits, suffused with a heavy dread. Guards stand ready, blocking the path to the lair of the Corrupted Guardian. Defeat them to gain access through the force field. This is your last chance to escape—prepare for the ultimate battle." }
    };
